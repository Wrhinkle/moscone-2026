...
| [Form3](form3.md) | Cloud-native single-API access to bank clearing and settlement schemes (Faster Payments, SEPA, BACS, CHAPS) | Supporting | ~$278M raised; ~$570M valuation (2024), Visa/Mastercard/Goldman on the cap table | The bank-grade settlement plumbing under neobanks like Klarna and N26, and the execution layer a money-moving agent ultimately calls |
